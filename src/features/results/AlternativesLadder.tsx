...
const CardRow = ({
  ...
  // A higher-net card is a genuine upside — paint the gain (and its value) green; the investment
  // barrier on its own row carries the "but…".
  const deltaTone = above ? "text-accent" : "text-ink-subtle";
  const valueTone = above ? "text-accent" : "text-ink";
